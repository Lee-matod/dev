...
def setup(bot: commands.Bot):
    set_settings(bot)
    bot.add_cog(Dev(bot))
    setup_(bot, extentions=["dev.functions.override", "dev.functions.python", "dev.functions.bot", "dev.functions.invoke"], commands=["override", "bot", "python", "execute", "reinvoke"])