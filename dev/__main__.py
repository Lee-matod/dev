...
async def setup(bot: commands.Bot):
    ...
    await setup_(bot, "dev.flags.help_command", "dev.flags.flags", "dev.config.over", "dev.config.bot", "dev.experimental.invoke", "dev.experimental.python", "dev.experimental.http")