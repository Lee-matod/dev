...
class CContext(commands.Context):
    def _set_properties(self, author: discord.Member, channel: discord.TextChannel):  # no need to initiate this class since we're not actually getting Context
        self._author = author
