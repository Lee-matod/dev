...
class GroupMixin(commands.GroupMixin):
    ...
    def group(self, name: str = MISSING, cls: Type[commands.Group] = MISSING, version: float = MISSING, parent: str = None, supports_virtual_vars: bool = False, *args, **kwargs) -> Callable:
    ...
    def command(self, name: str = MISSING, cls: Type[commands.Command] = MISSING, version: float = MISSING, parent: str = None, supports_virtual_vars: bool = False, *args, **kwargs) -> Callable:
        def decorator(func) -> Command:
            kwargs.setdefault("parent", self)
