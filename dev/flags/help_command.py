...
"""
dev.flags.help_command
~~~~~~~~~~~~~~~~~~~~~~

Help command made exclusively for the dev extension.
...
class RootHelp(Root):
    ...
    async def root_help(self, ctx: commands.Context, *, command: str = None):
        ...
        if cmd:
            ...
            sche = discord.Embed(title=cmd.qualified_name, description=cmd.short_doc or 'No description found.', color=discord.Color.darker_gray())
